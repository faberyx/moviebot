...
import { Grid, TextField, Button, FormControlLabel, Checkbox, Container, Avatar, Typography, Paper, Snackbar, LinearProgress, SnackbarCloseReason } from '@material-ui/core';
