import { SentimentResponse, ResponseCard as LexCard, Button, MessageFormatType, DialogState } from '@aws-sdk/client-lex-runtime-service';
import { Readable } from 'stream';
import { LexAttributes } from '../Utils/lexProvider';
...
export interface LexResponse {
   ...
   */
  sentimentResponse?: SentimentResponse | string;
  /**
